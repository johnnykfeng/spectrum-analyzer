...
if uploaded_file is not None:
    ...
    (N_MODULES, 
     ...
     y_positions, 
     heights, 
     df_transformed_list) = parse_uploaded_file(uploaded_file)
    ...
    with st.expander("PIXEL SPECTRUM", expanded=False):
        ...
        for c, column in enumerate(st.columns(num_pixels)):
            with column:
                ...
                if st.session_state.pixel_indices != [] and c < len(st.session_state.pixel_indices):
